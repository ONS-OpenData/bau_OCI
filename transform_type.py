...
obs_file['dim_item_id_4'] = obs_file['dim_item_id_4'].str[0:3]
...
obs_file['temp_dim'] = obs_file['dim_item_id_4'].map(lambda x: len(x))
...
obs_file['dim_item_id_3'] = obs_file['dim_item_id_3'].map(lambda x: x.replace('.0', ''))
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Month'] = obs_file['dim_item_id_4'] + ' ' + obs_file['dim_item_id_3']
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Quarter'] = obs_file['dim_item_id_3'] + ' ' + obs_file['dim_item_id_4']
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Year'] = obs_file['dim_item_id_3']
...
# Clear those random start and end spaces from Type
obs_file['dim_item_id_1'] = obs_file['dim_item_id_1'].map(str.strip)
