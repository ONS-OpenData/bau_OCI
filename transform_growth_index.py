...
# SORTING OUT TIME
obs_file['dim_item_id_7'] = obs_file['dim_item_id_7'].str[0:3]
...
obs_file['temp_dim'] = obs_file['dim_item_id_7'].map(lambda x: len(x))
...
obs_file['dim_item_id_6'] = obs_file['dim_item_id_6'].map(lambda x: x.replace('.0', ''))
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Month'] = obs_file['dim_item_id_7'] + ' ' + obs_file['dim_item_id_6']
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Quarter'] = obs_file['dim_item_id_6'] + ' ' + obs_file['dim_item_id_7']
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Year'] = obs_file['dim_item_id_6']
