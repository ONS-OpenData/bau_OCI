...
#load_file = 'data-Construction Output August v4-OCI-CVM-Prices-.csv'
...
obs_file['dim_item_id_6'][obs_file['dim_item_id_6'] == obs_file['dim_item_id_5']] = ''
obs_file['dimension_item_label_eng_6'] = obs_file['dim_item_id_6']

obs_file['dim_item_id_5'][obs_file['dim_item_id_5'] == obs_file['dim_item_id_4']] = ''
obs_file['dimension_item_label_eng_5'] = obs_file['dim_item_id_5']

obs_file['dim_item_id_4'][obs_file['dim_item_id_3'] == obs_file['dim_item_id_4']] = ''
...
obs_file['dim_item_id_3'] = obs_file['dim_item_id_3'].map(str.strip) + " " \
                                         ...
                                         + obs_file['dim_item_id_6'].map(str.strip)
...
for each in bad_list:
    obs_file['dim_item_id_3'] = obs_file['dim_item_id_3'].map(lambda x: x.replace(each, 'Infrastructure'))
obs_file['dimension_item_label_eng_3'] = obs_file['dim_item_id_3']

# SORTING OUT TIME
obs_file.fillna('', inplace = True)
obs_file['dim_item_id_8'] = obs_file['dim_item_id_8'].astype(str)
obs_file['dim_item_id_8'] = obs_file['dim_item_id_8'].str[0:3]
...
obs_file['temp_dim'] = obs_file['dim_item_id_8'].map(lambda x: len(x))
...
obs_file['dim_item_id_7'] = obs_file['dim_item_id_7'].map(lambda x: x.replace('.0', ''))
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Month'] = obs_file['dim_item_id_8'] + ' ' + obs_file['dim_item_id_7']
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Quarter'] = obs_file['dim_item_id_7'] + ' ' + obs_file['dim_item_id_8']
obs_file['time_dim_item_id'][obs_file['time_type'] == 'Year'] = obs_file['dim_item_id_7']
obs_file['time_dim_item_label_eng'] = obs_file['time_dim_item_id']
obs_file = tf.dismiss(obs_file, ['dim_id_4', 'dim_id_5', 'dim_id_6', 'dim_id_7', 'dim_id_8'])
